...
3. A parte imperativa foi a mais fácil de aplicar, porque é mais direta e parecida com o jeito tradicional de programar. Já a parte mais “funcional” foi um pouco mais difícil no começo, porque exige pensar em retornar novos valores em vez de só alterar variáveis.

4. Em relação à leitura e manutenção, o código fica relativamente fácil de entender porque está dividido em funções, mas conforme o programa cresce, a abordagem imperativa pode começar a ficar mais bagunçada. Já o uso de funções ajuda a deixar mais organizado e fácil de manter.
